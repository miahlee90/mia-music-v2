...
const NB_STR={ en:{
  ...
  "setup.beginnerDesc":"Treble · C4–G4 — one tap and fly!",
  "setup.gameLine":"🚀 Levels 1–10 · the bird speeds up · 3 ❤",
  ...
  "setup.rotateHint":"📱 Turn your phone sideways for full screen.",
  ...
  "setup.signInWhy":"Keep records under your name.",
  ...
  "setup.input.buttonsDesc":"Tap A–G on screen or press A–G on your keyboard.",
  "setup.input.midiDesc":"Play the exact note you see (octave matters). Buttons still work.",
  "setup.input.micDesc":"Play the exact note you see (octave matters) — piano, violin, cello… one note at a time. Buttons still work.",
  ...
  "mic.privacy":"Audio stays on this device — never recorded or uploaded.",
  ...
  "mic.needSetup":"Set up the microphone first — or continue without it.",
