/* Lesson 50 (7.2, formerly L49) — Scale Degree Names (AEMT Book 2, Unit 12)
...
function MF_L50_climb(container,fb){
...
function MF_L50_logic(container,fb){
  const ROUNDS=[
  ...
  steps:[
    ...
    { say:"The full ladder, in degree order: <b>Tonic, Supertonic, Mediant, Subdominant, Dominant, Submediant, Leading Tone</b> — then Tonic again. \u{1F447} <b>Climb it by name:</b>",
      try:{ type:"custom",
        ...
        mount:(container,fb)=>MF_L50_climb(container,fb) } },
