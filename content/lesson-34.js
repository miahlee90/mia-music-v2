/* Lesson 34 (5.2, formerly L35) — Perfect and Major Intervals (AEMT Book 2, Unit 9)
...
function MF_L34_ruler(container,fb){
  const ROUNDS=[
  ...
  steps:[
    ...
    { say:"Quality is measured in <b>HALF STEPS</b> — keyboard distance, black keys included. \u{1F447} <b>Grab the ruler: press every key and measure three intervals in half steps:</b>",
      try:{ type:"custom",
        ...
        mount:(container,fb)=>MF_L34_ruler(container,fb) } },
