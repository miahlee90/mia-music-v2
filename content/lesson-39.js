/* Lesson 39 (6.2, formerly L40) — Sixteenth Rests (AEMT Book 2, Unit 10)
...
function MF_L39_silent(container,fb){
  const SYL=["1","e","&","a"];
...
function MF_L39_hooks(container,fb){
  ...
  steps:[
    ...
    { say:"Speed drill — hooks at a glance. \u{1F447} <b>Eighth rest or sixteenth rest? Call each one:</b>",
      try:{ type:"custom",
        ...
        mount:(container,fb)=>MF_L39_hooks(container,fb) } },
    ...
    { say:"Ear practice — find the hole in the beat. \u{1F447} <b>One sixteenth of each beat is silent. Name the silent syllable:</b>",
      try:{ type:"custom",
        ...
        mount:(container,fb)=>MF_L39_silent(container,fb) } },
