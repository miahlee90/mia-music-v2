/* Lesson 84 (11.9, formerly L71) — The Blues Scale (AEMT Book 3, Unit 17 FINALE)
...
function MF_L84_convert(container,fb){
...
function MF_L84_improv(container,fb){
  ...
  steps:[
    ...
    { say:"<b>Build a Blues Scale:</b> Start with a major scale. <b>1) Remove the 2nd and 6th. · 2) Lower the 3rd and 7th. · 3) Add a lowered 5th.</b> \u{1F447} <b>Build the blues scale.</b>",
      ...
      try:{ type:"custom",
        ...
        mount:(container,fb)=>MF_L84_convert(container,fb) } },
    ...
    { say:"Now improvise your own solo — tap 5 notes from the blues scale and hear it play back. \u{1F447}",
      try:{ type:"custom",
        ...
        mount:(container,fb)=>MF_L84_improv(container,fb) } },
