/* Lesson 40 (6.3, formerly L41) — Dotted Eighth Notes (AEMT Book 2, Unit 10)
...
function MF_L40_feel(container,fb){
...
function MF_L40_calc(container,fb){
  let placed=0;
  ...
  steps:[
    ...
    { say:"Now aim the dot at the <b>eighth note</b>. Do the math with blocks: \u{1F447} <b>Build the dotted eighth from sixteenths:</b>",
      try:{ type:"custom",
        ...
        mount:(container,fb)=>MF_L40_calc(container,fb) } },
    ...
    { say:"Ear check — dotted or even? \u{1F447} <b>Judge each pair:</b>",
      try:{ type:"custom",
        ...
        mount:(container,fb)=>MF_L40_feel(container,fb) } },
