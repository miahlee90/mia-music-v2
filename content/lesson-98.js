/* Lesson 98 (14.9, formerly L101) — Theme and Variations (Book 4, Unit 25 — SELF-AUTHORED)
...
function MF_L98_ear(container,fb){
  ...
  steps:[
    ...
    { say:"Identify the principal variation technique used in each example. \u{1F447}",
      try:{ type:"custom",
        ...
        mount:(container,fb)=>MF_L98_ear(container,fb) } },
