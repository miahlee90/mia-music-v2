/* Lesson 57 (7.9, formerly L54) — Figured Bass (AEMT Book 3, Unit 13)
...
function MF_L57_count(container,fb){
  const ROUNDS=[
...
function MF_L57_build(container,fb){
  const ROUNDS=[
...
LESSON_CONTENT[57]={stackFigures:true,
  ...
  steps:[
    ...
    { say:"Count the intervals above the bass note to identify the chord. \u{1F447}",
      try:{ type:"custom",
        ...
        mount:(container,fb)=>MF_L57_count(container,fb) } },
    ...
    { say:"Build each chord from the <b>bass note</b> and the <b>figured bass numbers</b>. \u{1F447}",
      try:{ type:"custom",
        ...
        mount:(container,fb)=>MF_L57_build(container,fb) } },
  ...
  quiz:[
    ...
    { type:"mc", q:"Which figure represents the 2ND inversion of a triad?", choices:["6/4","5/3","6","4/2"], answer:0,
      explain:"Bass → root = 4th; bass → 3rd = 6th.", hint:"The nickname from Lesson 7.8." },
    ...
    { type:"mc", q:"In the key of C, the chord written I⁶₄ is spelled (bottom to top)…", choices:["G-C-E","C-E-G","E-G-C"], answer:0,
      explain:"2nd inversion: 5th in the bass.", hint:"6/4 = Lesson 7.8's chord." },
  ...
  miaPass:"Passed — the code is cracked! Lesson 9.3 puts the figures into real progressions.",
  mia:{
