...
LESSON_CONTENT[69]={stackFigures:true,
  welcome:"Where inversions stop being theory and start making music flow. \u{1F30A}",
  hook:{
  ...
  steps:[
    ...
    { say:"<b>Using V7:</b> The <b>V7 chord</b> is often used instead of <b>V</b> because it creates a <b>stronger pull</b> back to the tonic. \u{1F447} <b>In C major, which chord replaces G–B–D?</b>",
      try:{ type:"mc", choices:["G-B-D-F (G7)","G-B-D-F♯","F-A-C-E"], answer:0,
        success:"✓ Just add the minor 7th — the V7 chord slides right into the progression (full story in Lesson 10.1).",
        fail:"V7 = V + a minor 7th above the root…",
        hint:"V7 — the dominant plus a 7th." } },
  ...
  games:[
    { type:"gen-race", title:"Game 1 · Toolkit Sprint (45s)",
      intro:"Positions AND figures, triads AND sevenths — the full inversion arsenal at speed!",
      miaIntro:"Inversions and figures — everything at once! \u{1F9F0}",
    ...
    { type:"term-race", title:"Game 4 · SMOOTH-PROGRESSION GRAND FINALE Race",
      ...
      result:(score)=>score>=8?"CHAMPION — smooth progressions conquered!":null }
  ],
  ...
  miaQuizIntro:"Quiz time! Bass lines, common tones, figures — bring it all.",
  quiz:[
  ...
  summary:[
    ...
    "✔ The formula: <b>I → IV⁶₄ → I → V⁶(₅) → I</b>, bass line C-C-C-B-C. <b>THE SMOOTH FORMULA IS YOURS!</b> \u{1F389}"
  ],
  tips:[
    ...
    "Next lesson: the same progressions move into MINOR keys…"
  ],
  rewards:{ badge:"Smooth Operator", icon:"\u{1F30A}" },
  sectionOrder:["secHook","secObjectives","secLearn","secExample","secReview",
    "secGame0","secGame1","secGame2","secGame3","secPractice","secQuiz","secTips","secNext"],
  miaPerfect:"PERFECT — your progressions are beautifully smooth! \u{1F30A}\u{1F3C6}\u{1F389}",
  miaPass:"Passed! Inversions, figures, progressions: all yours. \u{1F389}",
  mia:{
    ...
    game:{ label:"the games",
      explain:"Sprint the whole toolkit, physically play the smooth progression, spot its four chords, then run the victory lap.",
