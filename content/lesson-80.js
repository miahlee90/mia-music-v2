/* Lesson 80 (11.5, formerly L65) — Broken Chords and Arpeggiated Accompaniments (AEMT Book 3, Unit 16)
...
function MF_L80_build(container,fb){
  const ROUNDS=[
  ...
  steps:[
    ...
    { say:"Play two arpeggios. \u{1F447}",
      try:{ type:"custom",
        ...
        mount:(container,fb)=>MF_L80_build(container,fb) } },
