/* Lesson 79 (11.4, formerly L68) — Harmonizing a Melody in a Minor Key (AEMT Book 3, Unit 17)
...
function MF_L79_harm(container,fb){
  const STEPS=[
  ...
  steps:[
    ...
    { say:"Harmonize the melody using the minor harmonizing chart. \u{1F447}",
      try:{ type:"custom",
        ...
        mount:(container,fb)=>MF_L79_harm(container,fb) } },
