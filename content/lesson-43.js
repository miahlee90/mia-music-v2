/* Lesson 43 (6.6, formerly L76) — Compound Meter Expanded (Book 4, Unit 19 — SELF-AUTHORED)
...
function MF_L43_fastlab(container,fb){
...
function MF_L43_conduct(container,fb){
  const PAT={
...
function MF_L43_ear(container,fb){
...
function MF_L43_playex(host, staff, kb, beatsPerBar, beatSec){
  ...
  steps:[
    ...
    { say:"<b>Conducting Patterns:</b> Conductors normally show the <b>main beats</b> rather than every division. At a moderate tempo, 6/8 uses a <b>two-beat</b> pattern, 9/8 uses a <b>three-beat</b> pattern, and 12/8 uses a <b>four-beat</b> pattern. These correspond to the basic conducting patterns used for duple, triple, and quadruple meter. \u{1F447} <b>Match each meter with its conducting pattern.</b>",
      try:{ type:"custom",
        ...
        mount:(container,fb)=>MF_L43_conduct(container,fb) } },
    ...
    { say:"Hear the collapse happen. \u{1F447} <b>Compare the same 6/8 passage slow and fast:</b>",
      try:{ type:"custom",
        ...
        mount:(container,fb)=>MF_L43_fastlab(container,fb) } },
    ...
    { say:"Listen and identify whether each beat divides into two or three equal parts. \u{1F447}",
      try:{ type:"custom",
        ...
        mount:(container,fb)=>MF_L43_ear(container,fb) } },
