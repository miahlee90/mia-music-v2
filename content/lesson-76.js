/* Lesson 76 (11.1, formerly L95) — Common Chord Progressions (Book 4, Unit 23 — SELF-AUTHORED)
...
LESSON_CONTENT[76]={stackFigures:true,
  ...
  practice:[
    ...
    { type:"truefalse", q:"ii-V-I commonly follows the functional path PD → D → T.", answer:true,
      explain:"Lesson 9.1's flow, condensed." },
  ...
  tips:[
    ...
    "Next lesson: voice leading — how each voice walks smoothly from chord to chord."
  ],
  ...
  quiz:[
    ...
    { type:"mc", q:"Which progression is conventionally organized as a twelve-measure formal cycle?", choices:["Twelve-bar blues","I-V-vi-IV","ii-V-I"], answer:0,
      explain:"Twelve-bar blues uses a conventional twelve-measure framework, although its chord details may vary.", hint:"The 12-bar framework — Lesson 11.8 dives in." },
    ...
    { type:"truefalse", q:"In jazz and related styles, ii-V-I frequently appears with seventh chords.", answer:true,
      explain:"Dm7-G7-Cmaj7 — three seventh types chained.", hint:"Lesson 10.3's example." },
