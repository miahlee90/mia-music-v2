/* Lesson 85 (12.1, formerly L66) — Passing and Neighboring Tones (AEMT Book 3, Unit 16)
...
function MF_L85_detect(container,fb){
  const ROUNDS=[
  ...
  steps:[
    ...
    { say:"Identify each non-harmonic tone. \u{1F447}",
      try:{ type:"custom",
        ...
        mount:(container,fb)=>MF_L85_detect(container,fb) } },
