/* Lesson 106 (15.6, formerly L109) — Modern Color Chords: Sus, Add, and Sixth Chords (Book 4, Unit 27 — SELF-AUTHORED)
...
function MF_L106_mount(container,fb,cfg){
...
LESSON_CONTENT[106]={
  ...
  steps:[
    ...
    { say:"<b>Gsus4 Resolving to G:</b> The classic guitar-and-worship gesture — the fourth leans in, then falls to the third. \u{1F447} <b>Answer after listening.</b>",
      try:{ type:"custom", mount:(c,fb)=>MF_L106_mount(c,fb,{
        heading:"Key: G major",
