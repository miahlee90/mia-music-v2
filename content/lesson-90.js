/* Lesson 90 (14.1, formerly L72) — Basic Forms of Music: Motive and Phrase (AEMT Book 3, Unit 18)
...
function MF_L90_hunt(container,fb){
...
function MF_L90_breath(container,fb){
  ...
  steps:[
    ...
    { say:"Listen for the motive. <b>How many times do you hear it?</b> Tap the first note of each appearance. \u{1F447}",
      try:{ type:"custom",
        ...
        mount:(container,fb)=>MF_L90_hunt(container,fb) } },
    ...
    { say:"Listen and find where each phrase ends. \u{1F447}",
      try:{ type:"custom",
        ...
        mount:(container,fb)=>MF_L90_breath(container,fb) } },
