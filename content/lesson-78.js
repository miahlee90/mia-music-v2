/* Lesson 78 (11.3, formerly L64) — Harmonizing a Melody in a Major Key (AEMT Book 3, Unit 16)
...
function MF_L78_harm(container,fb){
  const STEPS=[
  ...
  steps:[
    ...
    { say:"Harmonize the melody using the chart. \u{1F447}",
      try:{ type:"custom",
        ...
        mount:(container,fb)=>MF_L78_harm(container,fb) } },
