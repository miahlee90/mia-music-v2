/* Lesson 44 (6.7, formerly L45) — Eighth Note Triplets (AEMT Book 2, Unit 11)
...
function MF_L44_ear(container,fb){
...
function MF_L44_tap(container,fb){
  ...
  steps:[
    ...
    { say:"Ear training — duple or triple? \u{1F447} <b>Two even eighths, or a triplet? Judge each beat:</b>",
      try:{ type:"custom",
        ...
        mount:(container,fb)=>MF_L44_ear(container,fb) } },
    { say:"Now PERFORM one. \u{1F447} <b>Tap three even notes inside each beat:</b>",
      try:{ type:"custom",
        ...
        mount:(container,fb)=>MF_L44_tap(container,fb) } },
