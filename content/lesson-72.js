...
LESSON_CONTENT[72]={stackFigures:true,
  ...
  games:[
    ...
    { type:"term-race", title:"Game 4 · Inversion Fact Race",
      ...
      miaIntro:"Triad flips AND V7 flips — everything! \u{1F3C1}",
  ...
  quiz:[
    ...
    { type:"mc", q:"Which chord tone is in the bass of a FIRST-inversion V7 chord?", choices:["The 3rd","The root","The 5th","The 7th"], answer:0,
      explain:"Same as triads: first flip puts the 3rd in the bass.", hint:"Lesson 7.7's rule carries over." },
  ...
  miaPass:"Passed! Root, 3rd, 5th, 7th — the whole ladder is yours. (The figures? You met them in Lesson 7.9!)",
  mia:{
