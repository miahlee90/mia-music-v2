/* Lesson 55 (7.7, formerly L51) — Triads: 1st Inversion (AEMT Book 3, Unit 13) — BOOK 3 OPENER
...
function MF_L55_flip(container,fb){
  const ROUNDS=[
...
function MF_L55_detect(container,fb){
  const ROUNDS=[
...
LESSON_CONTENT[55]={stackFigures:true,
  ...
  steps:[
    ...
    { say:"Move the <b>root</b> up one octave. The <b>3rd</b> becomes the lowest note, creating <b>1st INVERSION</b>. \u{1F447} <b>Try it — tap the root:</b>",
      try:{ type:"custom",
        ...
        mount:(container,fb)=>MF_L55_flip(container,fb) } },
    ...
    { say:"<b>Identify the inversion.</b> Find the <b>lowest note</b> first, then name the chord position. \u{1F447}",
      try:{ type:"custom",
        ...
        mount:(container,fb)=>MF_L55_detect(container,fb) } },
  ...
  quiz:[
    ...
    { type:"mc", q:"Moving the ROOT of a root-position triad up one octave creates…", choices:["the 1st inversion","the 2nd inversion","an entirely new chord"], answer:0,
      explain:"One flip = 1st inversion. (The next flip comes in Lesson 7.8!)", hint:"Count the flips." },
  ...
  tips:[
    ...
    "In Lesson 7.8 the chord flips AGAIN — guess which note will be in the bass next!",
  ...
  miaPass:"Passed! The 3rd-in-the-bass rule is yours. Lesson 7.8 flips the chord one more time…",
  mia:{
